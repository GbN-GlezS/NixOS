...

{
  ...
  xdg.desktopEntries = {
    "brave-github" = {
      ...
      exec = "brave --start-maximized --app=https://github.com/";
      icon = "github";
      terminal = false;
      type = "Application";
      categories = [
    ...
    "brave-mynixos" = {
      ...
      exec = "brave --start-maximized --app=https://mynixos.com/";
      icon = "nix-snowflake";
      terminal = false;
      type = "Application";
      categories = [
    ...
    "brave-nixos-wiki" = {
      ...
      exec = "brave --start-maximized --app=https://wiki.nixos.org/wiki/NixOS_Wiki";
      icon = "nix-snowflake";
      terminal = false;
      type = "Application";
      categories = [
    ...
    "brave-youtube" = {
      ...
      exec = "brave --start-maximized --app=https://www.youtube.com/";
      icon = "youtube";
      terminal = false;
      type = "Application";
      categories = [
